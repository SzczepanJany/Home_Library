...
urlpatterns = [
    ...
    path('details_serie/<int:pk>/', shelf_view.SerieDetailView.as_view(), name='detail_serie'),
    ...
    path('add_return/<int:pk>/', shelf_view.CreateNewReturnView.as_view(), name ='add_return'),
