    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='shelfs.description')),
            ],
        ),
        migrations.CreateModel(
            name='Item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='series', to='shelfs.description')),
            ],
        ),
        migrations.CreateModel(
            name='Rate',
            fields=[
                ...
                ('description', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rates', to='shelfs.description')),
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='rates', to='shelfs.item')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='rates', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Publisher',
            fields=[
                ...
                ('description', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='publishers', to='shelfs.description')),
            ],
        ),
        migrations.CreateModel(
            name='Loan',
            fields=[
                ...
                ('description', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='loans', to='shelfs.description')),
        ...
        migrations.AddField(
            model_name='user',
            name='description',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='users', to='shelfs.description'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
